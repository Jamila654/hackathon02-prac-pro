...
const ProductDetails = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col">
      ...
      <div className="flex flex-col md:flex-row p-4 md:p-6 gap-6 md:gap-0 items-center justify-around">
          ...
          <Card className="w-full h-auto rounded-lg">
            ...
            <CardContent className="flex flex-col gap-4">
              ...
              <div className="buttons w-full flex items-center justify-between mt-4">
                <div className="plus-minus flex items-center gap-2">
                  <button
                ...
                <button
                  ...
                  className="px-6 py-3 bg-black text-white rounded-full flex items-center justify-center hover:bg-gray-800 transition-colors duration-200"
                >
